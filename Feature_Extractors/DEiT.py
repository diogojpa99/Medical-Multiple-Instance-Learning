...
from Feature_Extractors.ViT import VisionTransformer, trunc_normal_, checkpoint_filter_fn
...
def deit_small_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    model = _create_deit('deit_small_patch16_224', pretrained=pretrained, **dict(**kwargs))
    return model
