...
from timm.models._manipulate import MATCH_PREV_GROUP
...
def densenet169(pretrained=False, **kwargs) -> DenseNet:
    ...
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`
    """
    if kwargs.get('block_config'):
        block_config = kwargs.pop('block_config')
    else:
        block_config=(6, 12, 32, 32)
    
    model = _create_densenet(
        'densenet169', growth_rate=32, block_config=block_config, pretrained=pretrained, **kwargs)
    return model
